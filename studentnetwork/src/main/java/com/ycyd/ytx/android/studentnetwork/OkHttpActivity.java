...
public class OkHttpActivity extends AppCompatActivity {
        ...
        sendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            private void sendRequestWithOkHttp() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try{
                            ...
                            Request request=new Request.Builder()
                                    ...
                                    .url("http://10.28.4.176:8091/app/test.xml")
                    ...
                    private void parseXML(final String s) {
                    ...
                    private void parseXMLPull(String reader) {
                        ...
                        try {
                            ...
                            responseTextView.setText(stringResult.toString());
    ...
    private void parseXMLSAX(String reader) {
        //SAX解析
        try {
            //1.创建解析工厂
            ...
            //读取xml的文档内容
            Log.d("httpreader", "parseXMLSAX: "+reader);
